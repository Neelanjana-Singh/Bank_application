...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-white px-5">
		<div class="container-fluid">
			...
			<a class="navbar-brand nav-link" href="user?command=newtransaction">New
				Transactions</a> <a class="navbar-brand nav-link"
				href="user?command=editProfile">Edit Profile</a>
		</div>
	</nav>
	<hr>
