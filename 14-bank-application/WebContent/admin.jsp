...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-white px-5">
		<div class="container-fluid">
			<a class="navbar-brand nav-link" href="admin?command=addCustomer">Add
				New Customer</a> <a class="navbar-brand nav-link"
				href="admin?command=viewCustomer">View Customers</a> <a
				class="navbar-brand nav-link" href="admin?command=transaction">View
				Transactions</a>
		</div>
	</nav>
